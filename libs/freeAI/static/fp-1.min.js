...
var document = {
    ...
    referrer: 'https://www.deepseek.com/',
    createElement: e => {
        return {
            'getContext': e => {
                return {
